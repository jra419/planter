...
import binascii
import sys
sys.path.append('/home/docker/planter')
os.chdir('/home/docker/planter')
...
Ingress = bfrt.kitsune-active-wiretap-rf.pipe.SwitchIngress
Ingress.clear()
...
for k in range(len(table['feature 4'].keys())):
    ...
    codes = ''
    for tree in range(config['number of trees']):
        codes = ten_to_bin(int(table['feature 4'][key][2][tree]), int(config['width of code'][tree][4])) + codes
    Ingress.lookup_feature4.add_with_extract_feature4(table['feature 4'][key][1], table['feature 4'][key][0], int(key), int(codes,2))
print('load tree (code/code to vote) 0 table with',len(table['tree 0'].keys()),'entries')
for key in table['tree 0']:
    Ingress.lookup_leaf_id0.add_with_read_prob0(table['tree 0'][key]['f0 code'], table['tree 0'][key]['f1 code'], table['tree 0'][key]['f2 code'], table['tree 0'][key]['f3 code'], table['tree 0'][key]['f4 code'], 0, table['tree 0'][key]['leaf'])
print('load tree (code/code to vote) 1 table with',len(table['tree 1'].keys()),'entries')
for key in table['tree 1']:
    Ingress.lookup_leaf_id1.add_with_read_prob1(table['tree 1'][key]['f0 code'], table['tree 1'][key]['f1 code'], table['tree 1'][key]['f2 code'], table['tree 1'][key]['f3 code'], table['tree 1'][key]['f4 code'], 0, table['tree 1'][key]['leaf'])
print('load tree (code/code to vote) 2 table with',len(table['tree 2'].keys()),'entries')
for key in table['tree 2']:
    Ingress.lookup_leaf_id2.add_with_read_prob2(table['tree 2'][key]['f0 code'], table['tree 2'][key]['f1 code'], table['tree 2'][key]['f2 code'], table['tree 2'][key]['f3 code'], table['tree 2'][key]['f4 code'], 0, table['tree 2'][key]['leaf'])
print('load tree (code/code to vote) 3 table with',len(table['tree 3'].keys()),'entries')
for key in table['tree 3']:
    Ingress.lookup_leaf_id3.add_with_read_prob3(table['tree 3'][key]['f0 code'], table['tree 3'][key]['f1 code'], table['tree 3'][key]['f2 code'], table['tree 3'][key]['f3 code'], table['tree 3'][key]['f4 code'], 0, table['tree 3'][key]['leaf'])
print('load tree (code/code to vote) 4 table with',len(table['tree 4'].keys()),'entries')
for key in table['tree 4']:
    Ingress.lookup_leaf_id4.add_with_read_prob4(table['tree 4'][key]['f0 code'], table['tree 4'][key]['f1 code'], table['tree 4'][key]['f2 code'], table['tree 4'][key]['f3 code'], table['tree 4'][key]['f4 code'], 0, table['tree 4'][key]['leaf'])
print('load tree (code/code to vote) 5 table with',len(table['tree 5'].keys()),'entries')
for key in table['tree 5']:
    Ingress.lookup_leaf_id5.add_with_read_prob5(table['tree 5'][key]['f0 code'], table['tree 5'][key]['f1 code'], table['tree 5'][key]['f2 code'], table['tree 5'][key]['f3 code'], table['tree 5'][key]['f4 code'], 0, table['tree 5'][key]['leaf'])
print('load vote to class (decision) table with',len(table['decision'].keys()),'entries')
for key in table['decision']:
    Ingress.decision.add_with_read_lable(table['decision'][key]['t0 vote'], table['decision'][key]['t1 vote'], table['decision'][key]['t2 vote'], table['decision'][key]['t3 vote'], table['decision'][key]['t4 vote'], table['decision'][key]['t5 vote'], table['decision'][key]['class'])
